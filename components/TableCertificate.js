...
export function TableCertificate({ data, columns, toggleCleared, setSelectedRows, setToggleCleared }) {
  ...
  const filteredItems = data.filter(
    item => item.dateSubmitted && item.dateSubmitted.toLowerCase().includes(filterText.toLowerCase()),
  );
